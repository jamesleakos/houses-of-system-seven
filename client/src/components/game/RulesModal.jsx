  ...
  return (
    <div className="rules-modal" onClick={() => setRulesOn(false)}>
      <div className="interior">
        ...
        <br />
        <p>
          In addition to being challenged, some actions can also be BLOCKED by certain other delegates. In a block, a player accepts that an
          action was performed by a player holding the appropriate delegate, but they claim they are holding a delegate that can counter it.
          This block, a counter action, can also be challenged.
        </p>
        <br />
